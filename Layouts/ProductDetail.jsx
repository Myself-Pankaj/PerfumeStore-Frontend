...
import { addToCart } from "../States/Cart/cartAction";
import HangOn from "../Components/HangOn";
import { getProductDetails } from "../States/Product/productAction";
import { newReviewReducer } from "../States/Review/reviewReducer";
  ...
  const addToCartHandler = async () => {
    ...
    if (!isAuthenticated || !isVerified) {
      ...
      Toast.show({
        ...
        text2: 'Please log in and verify your account to add items to your bag.',
      });
      return; 
    }
...
const handleReviewSubmit = async () => {
  ...
  if (!isAuthenticated || !isVerified) {
    ...
    Toast.show({
      type: 'info',
      text1: 'Authentication Required',
      text2: 'Please log in and verify your account to submit a review.',
    });
    return; 
  }
  ...
  try {
    await dispatch(newReviewReducer(reviewData));
    ...
    Toast.show({
      type: 'error',
      text1: 'Review Submission Error',
      text2: 'There was an error while submitting your review. Please try again later.',
    });
  }
};
          ...
          >
            ...
            <View style={styles.detailsContainer}>
              ...
              <Text style={styles.productPrice}>
                ...
                <Text style={styles.productSubPrice}>
              ...
              <View style={styles.descriptionContainer}>
                ...
                <RenderHtml contentWidth={250} source={source} />
              </View>
            </View>
